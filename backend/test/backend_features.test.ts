    ...
    it('should initialize with config', () => {
        ...
        describe('Table Features', () => {
            ...
            it('should track ledger and allow host to add chips', () => {
                ...
                const player = { id: 'p1', name: 'Player 1', chips: 1000, bet: 0, folded: false, cards: [], seat: 0, isTurn: false, hasActed: false, status: 'active' as const };
            ...
            it('should allow host transfer', () => {
                const table = new Table(config);
                const p1 = { id: 'p1', name: 'Player 1', chips: 1000, bet: 0, folded: false, cards: [], seat: 0, isTurn: false, hasActed: false, status: 'active' as const };
                const p2 = { id: 'p2', name: 'Player 2', chips: 1000, bet: 0, folded: false, cards: [], seat: 1, isTurn: false, hasActed: false, status: 'active' as const };
                table.addPlayer(p1);
                table.addPlayer(p2);
