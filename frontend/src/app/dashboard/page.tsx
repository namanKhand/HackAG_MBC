            ...
            <div className="max-w-6xl mx-auto">
                <header className="flex justify-between items-center mb-12">
                    ...
                    <button
                        ...
                        className="px-6 py-2 bg-blue-600 hover:bg-blue-500 rounded-lg transition-colors font-bold shadow-lg shadow-blue-900/20"
                    >
                        Play Now
                    </button>
                </header>
                ...
                <div className="bg-gray-800/50 border border-gray-700 rounded-2xl p-8">
                    <h2 className="text-2xl font-bold mb-6">Recent Winnings</h2>
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="border-b border-gray-700 text-gray-400 text-sm">
                                    ...
                                    <th className="pb-4">Pot Size</th>
                                    <th className="pb-4">Table</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-700">
                                {history.map((game: { id: string; timestamp: string; result: string; profit: number; hand_description: string; pot_size: number; table_id: string }, i: number) => (
